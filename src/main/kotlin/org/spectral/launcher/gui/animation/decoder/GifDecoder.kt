...
package org.spectral.launcher.gui.animation.decoder
        ...
        if (lastDispose > 0) {
            ...
            if (lastImage != null) {
                ...
                if (lastDispose == 2) {
                    ...
                    var c: Color? = null
                    if (transparency) {
                        c = Color(0, 0, 0, 0) // assume background is transparent
                    } else {
                        c = Color(lastBgColor) // use given background color
                    }
                    g.color = c
